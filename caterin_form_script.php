<?php
$cateringname=addslashes($_POST["txtcatname"]);
...
if($filename_tmp!="")
{
 ...
 if($cateringname!="" && $contactno!="" && $content!="")
 {
$sql="insert into catering_tbl(cid,cateringname,contactno,content,photofile,activestatus)
values('$id','$cateringname','$contactno','$content','$filename','$activestatus')";
//echo($sql);
mysql_query($sql);
