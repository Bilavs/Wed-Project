<?php
$id=$_POST["txtid"];
$djname=stripslashes($_POST["txtdjname"]);
...
$sql="update dj_tbl set djname='$djname',contactno='$contactno',content='$content',activestatus='$activestatus' $str where djid=$id";
//echo($sql);
mysql_query($sql);
