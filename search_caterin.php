...
<div class="panel">
    <div class="panel-body">
        ...
        <div class="example-box-wrapper">
            <form class="form-horizontal bordered-row" method="" action="" onSubmit="searchcaterin(this);return false;">
...
if($rc>0)
{
	...
	{		
		 ?>
         <option value="<?php echo(mysql_result($res,$c,"cid"));?>">
		  <?php echo(mysql_result($res,$c,"cateringname"));?></option>
         <?php
	}
}
?></option>
