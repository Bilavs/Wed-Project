<?php
$palacename=addslashes($_POST["txtpname"]);
...
if($filename_tmp!="")
{
 ...
 if($palacename!="" && $contactno!="" && $content!="")
 {
$sql="insert into palace_tbl(pid,palacename,contactno,content,photofile,activestatus)
values('$id','$palacename','$contactno','$content','$filename','$activestatus')";
//echo($sql);
mysql_query($sql);
