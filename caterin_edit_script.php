<?php
$id=$_POST["txtid"];
$cateringname=stripslashes($_POST["txtcatname"]);
...
$sql="update catering_tbl set cateringname='$cateringname',contactno='$contactno',content='$content',activestatus='$activestatus' $str where cid=$id";
//echo($sql);
mysql_query($sql);
