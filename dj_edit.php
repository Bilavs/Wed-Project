...
?>
            <form class="form-horizontal bordered-row" id="form1" name="form1" action="" method="" onSubmit="updatedj(this); return false;">
                <div class="form-group">
                    <label class="col-sm-3 control-label">DJ Name</label>
                    <div class="col-sm-6">
                        <input name="txtdjname" type="text" data-parsley-trigger="focusin focusout"  data-parsley-pattern="[A-Za-z]+" required class="form-control" id="txtdjname" placeholder="djname" value="<?php echo (mysql_result($res,0,"djname"));?>">
                        <input type="hidden" id="txtid" name="txtid" value="<?php echo mysql_result($res,0,"djid"); ?>" />
                    </div>
                </div>
               <div class="form-group">
