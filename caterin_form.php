...
<div class="panel">
    <div class="panel-body">
        <h3 class="title-hero" align="center">
           Provide Your Catering Service Details!!!!
        </h3>
        <div class="example-box-wrapper">
            <form class="form-horizontal bordered-row" action="" method="" onSubmit="savecaterin(this); return false;">
                <div class="form-group">
                    <label class="col-sm-3 control-label">Catering Name</label>
                    <div class="col-sm-6">
                        <input name="txtcatname" id="txtcatname" type="text" data-parsley-trigger="focusin focusout"  data-parsley-pattern="[A-Za-z]+" class="form-control" id="txtcatname" placeholder="Cateringname" required>
                    </div>
                </div>
              <div class="form-group">
        ...
        <div class="form-group">
                ...
                <div class="bg-default content-box text-center pad20A mrg25T">
                    ...
                    <button class="btn btn-lg btn-primary" onClick="clearcaterin()">Add More</button>
                </div>
