...
function scrolloramaInit(){
    ...
    controller
        ...
        .addTween('.s50', TweenMax.from( $('.s50'), 1.0, {delay: 0.0, css:{opacity: 0 , "margin-bottom": "20"}, ease: Cubic.easeOut}),0 , -330)
        .addTween('.s51', TweenMax.from( $('.s51'), 1.0, {delay: 0.0, css:{opacity: 0 , "margin-bottom": "20"}, ease: Cubic.easeOut}),0 , -330)
        .addTween('.s52', TweenMax.from( $('.s52'), 1.0, {delay: 0.0, css:{opacity: 0 , "margin-bottom": "20"}, ease: Cubic.easeOut}),0 , -330)
        .addTween('.s53', TweenMax.from( $('.s53'), 1.0, {delay: 0.0, css:{opacity: 0 , "margin-bottom": "20"}, ease: Cubic.easeOut}),0 , -330)
        .addTween('.s54', TweenMax.from( $('.s54'), 1.0, {delay: 0.0, css:{opacity: 0 , "margin-bottom": "20"}, ease: Cubic.easeOut}),0 , -330)
        .addTween('.s55', TweenMax.from( $('.s55'), 1.0, {delay: 0.0, css:{opacity: 0 , "margin-bottom": "20"}, ease: Cubic.easeOut}),0 , -330)
        .addTween('.s56', TweenMax.from( $('.s56'), 1.0, {delay: 0.0, css:{opacity: 0 , "margin-bottom": "20"}, ease: Cubic.easeOut}),0 , -330)
        .addTween('.s57', TweenMax.from( $('.s57'), 1.0, {delay: 0.0, css:{opacity: 0 , "margin-bottom": "20"}, ease: Cubic.easeOut}),0 , -330)
        .addTween('.s58', TweenMax.from( $('.s58'), 1.0, {delay: 0.0, css:{opacity: 0 , "margin-bottom": "20"}, ease: Cubic.easeOut}),0 , -330)
        .addTween('.s59', TweenMax.from( $('.s59'), 1.0, {delay: 0.0, css:{opacity: 0 , "margin-bottom": "20"}, ease: Cubic.easeOut}),0 , -330)
        .addTween('.s60', TweenMax.from( $('.s60'), 1.0, {delay: 0.0, css:{opacity: 0 , "margin-bottom": "20"}, ease: Cubic.easeOut}),0 , -330)
