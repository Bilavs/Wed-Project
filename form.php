...
<!-- Mirrored from demo.agileui.com/delight/demo/admin-template/forms-validation.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Jun 2015 07:11:48 GMT -->
<head>
    ...
    <div class="scrollable-content scrollable-slim-sidebar">
        <div class="pad10A">
            ...
            <ul class="chat-box">
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="assets-minified/image-resources/people/testimonial1.jpg" alt="">
                ...
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="assets-minified/image-resources/people/testimonial2.jpg" alt="">
                        <div class="small-badge bg-green"></div>
                    </div>
                    <b>
                        Carl Gamble
                ...
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="assets-minified/image-resources/people/testimonial3.jpg" alt="">
                        <div class="small-badge bg-green"></div>
                    </div>
                    <b>
                        Michael Poole
                ...
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="assets-minified/image-resources/people/testimonial4.jpg" alt="">
                        <div class="small-badge bg-green"></div>
                    </div>
                    <b>
                        Bill Green
                ...
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="assets-minified/image-resources/people/testimonial5.jpg" alt="">
                        <div class="small-badge bg-green"></div>
                    </div>
                    <b>
                        Cheryl Soucy
            ...
            <ul class="chat-box">
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="assets-minified/image-resources/people/testimonial6.jpg" alt="">
                ...
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="assets-minified/image-resources/people/testimonial7.jpg" alt="">
                        <div class="small-badge bg-orange"></div>
                    </div>
                    <b>
                        Dan Garcia
                ...
                <li>
                    <div class="status-badge">
                        <img class="img-circle" width="40" src="../../assets-minified/image-resources/people/testimonial8.jpg" alt="">
                        <div class="small-badge bg-orange"></div>
                    </div>
                    <b>
                        Edward Bridges
...
<div id="page-sidebar">
    <div id="header-logo" class="logo-bg">
        <a href="index-2.html" class="logo-content-big" title="DelightUI">
            Delight <i>UI</i>
            <span>Material Design Dashboard Template</span>
        </a>
        <a href="index-2.html" class="logo-content-small" title="DelightUI">
            Delight <i>UI</i>
            <span>Material Design Dashboard Template</span>
        </a>
    ...
    <li>
        <a href="index-2.html" title="Admin Dashboard">
    ...
    <li>
        ...
        <div class="sidebar-submenu">
            ...
            <ul>
                <li><a href="login-1.html" target="_blank.html" title="Login page 1"><span>Login page 1</span></a></li>
                <li><a href="login-2.html" target="_blank.html" title="Login page 2"><span>Login page 2</span></a></li>
                <li><a href="login-3.html" target="_blank.html" title="Login page 3"><span>Login page 3</span></a></li>
                <li><a href="login-4.html" target="_blank.html" title="Login page 4"><span>Login page 4</span></a></li>
                <li><a href="login-5.html" target="_blank.html" title="Login page 5"><span>Login page 5</span></a></li>
                <li><a href="lockscreen-1.html" target="_blank.html" title="Lockscreen page 1"><span>Lockscreen page 1</span></a></li>
                <li><a href="lockscreen-2.html" target="_blank.html" title="Lockscreen page 2"><span>Lockscreen page 2</span></a></li>
                <li><a href="lockscreen-3.html" target="_blank.html" title="Lockscreen page 3"><span>Lockscreen page 3</span></a></li>
                <li><a href="server-1.html" target="_blank.html" title="Server page 1"><span>Error 404 page</span></a></li>
                <li><a href="server-2.html" target="_blank.html" title="Server page 2"><span>Error 404 alternate</span></a></li>
                <li><a href="server-3.html" target="_blank.html" title="Server page 3"><span>Server 500 error</span></a></li>
            </ul>
    ...
    <div id="header-nav-left">
        ...
        <div class="user-account-btn dropdown">
            <a href="#" title="My Account" class="user-profile clearfix" data-toggle="dropdown">
                <img width="28" src="../../assets-minified/image-resources/gravatar.jpg" alt="Profile image">
                ...
                <div class="box-sm">
                    <div class="login-box clearfix">
                        <div class="user-img">
                            ...
                            <img src="../../assets-minified/image-resources/gravatar.jpg" alt="">
                        </div>
                        <div class="user-info">
                            <span>
                                Michael Lee
...
<div id="page-title">
    ...
    <p>Easy add validation for form elements without writing code.</p>
...
<!-- Mirrored from demo.agileui.com/delight/demo/admin-template/forms-validation.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Jun 2015 07:11:57 GMT -->
</html>