...
<div class="panel">
    <div class="panel-body">
        ...
        <div class="example-box-wrapper">
            <form class="form-horizontal bordered-row" method="" action="" onSubmit="searchoutfits(this);return false;">
                <div class="form-group">
                    <label class="col-sm-3 control-label">Chosen select</label>
                    <div class="col-sm-6">
                        <select  class="chosen-select" name="catbox2" id="catbox2">
                            <optgroup label="Catering Providers">
                                <option><?php
include("mysql_connect.php");
$sql="select * from outfits_tbl";
$res=mysql_query($sql);
...
if($rc>0)
{
	...
	{		
		 ?>
         <option value="<?php echo(mysql_result($res,$c,"oid"));?>">
		  <?php echo(mysql_result($res,$c,"outfitname"));?></option>
         <?php
	}
}
?></option>
