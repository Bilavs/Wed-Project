...
<div class="panel panel-default mat">
  ...
  <p style="font-weight:bold; font-size:23px">Venue's Details</p>
 <hr style="margin: 0px 0px 15px 0px;">
  <p>VEG PRICE</p>
  <p class="h5">700 per plate</p>
  <p>NON VEG PRICE</p>
  <p class="h5">800 per plate</p>
  <p>SPACE AVAILABLE</p>
  <p class="h5">Both indoor and outdoor option are available</p>
  <p>VENUE TYPE</p>
  <p class="h5">Hotel</p>
  <p>ROOMS</p>
  <p class="h5">Available</p>
  <p>CATERING POLICY</p>
 <p class="h5"> Inhouse catering, Outside vendors not permitted</p>
  <p>DECOR POLICY</p>
  <p class="h5">Decorators should be chosen only from enlisted Panel</p>
  <p>OUTSIDE ALCOHOL</p>
  <p class="h5">In house alcohol available, Outside alcohol permitted</p>
  <p>STANDARD MENU INCLUDES</p>
  <p class="h5">2 NON VEGETARIAN SNACKS
 2 VEGETARIAN SNACKS (Paneer / Veg)
 2 SOUP
 3 SALADS
 1 CURD
 PAPAD / PICKLE / CHUTNEY
 2 NON VEGETARIAN MAIN COURSE
 3 VEG MAIN COURSE (Including 1 Paneer)
 1 RICE PREPARATION
 1 DAL PREPARATION
...
<h5 class="mar_t_25"><?php echo(mysql_result($res,0,"palacename"))?></h5>
<p class="mar_t_05">
