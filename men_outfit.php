...
<html lang="en">
<head>
<title>Groom outfits-Best price in Wedlock</title>
<meta charset="utf-8">
...
$sql="select * from outfits_tbl where outfit_category='Male'";
$res=mysql_query($sql);
...
<h5 class="mar_t_05"><?php echo(mysql_result($res,$c,"outfitname"));?></h5>
...
<a href="men_outfit_details.php?id=<?php echo(mysql_result($res,$c,"oid"));?>" class="btn-default mar_t_2"><em>Read more</em></a>
</div>
</div>
<?php
}
