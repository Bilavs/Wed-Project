...
<div class="panel">
    <div class="panel-body">
        ...
        <div class="example-box-wrapper">
            <form class="form-horizontal bordered-row" method="" action="" onSubmit="searchdj(this);return false;">
                <div class="form-group">
                    <label class="col-sm-3 control-label">Chosen select</label>
                    <div class="col-sm-6">
                        <select  class="chosen-select" name="catbox2" id="catbox2">
                            <optgroup label="DJ Name">
                                <option><?php
include("mysql_connect.php");
$sql="select * from dj_tbl";
$res=mysql_query($sql);
...
if($rc>0)
{
	...
	{		
		 ?>
         <option value="<?php echo(mysql_result($res,$c,"djid"));?>">
		  <?php echo(mysql_result($res,$c,"djname"));?></option>
         <?php
	}
}
?></option>
